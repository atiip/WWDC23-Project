          ...
          .background(Color("bg-btn")).opacity(0.5)
            ...
            Spacer()
                Button(action: {
                        ...
                        NavigationLink(destination: ClothesView(isSelectedClothes: $isSelectedClothes, isHat: $isHat)){
                        ...
                        if (collision1 == true){
                            Image("putih-putih-biru")
                                ...
                                .onAppear {
                                    imageWidth = value.size.width
                                    imageHeight = value.size.height
                                    isSelectedClothes = "putih-putih-biru"
                                    isHat = "putih"
                                }
                        
                        }
                        if (collision2 == true){
                            Image("hitam-putih-biru")
                                ...
                                .onAppear {
                                    imageWidth = value.size.width
                                    imageHeight = value.size.height
                                    isSelectedClothes = "hitam-putih-biru"
                                    isHat = "hitam"
                                }
